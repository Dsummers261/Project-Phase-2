...
def GetDatesWorked():
    ...
    fromdate= input ("Please insert date in the following format mm/dd/yyyy: ")
    todate= input("Please insert todays date in the following format mm/dd/yyyy: ")
...
def printinfo(EmpDetailList):
    ...
    for EmpList in EmpDetailList:
        ...
        EmpTotals["TotEmp"] = TotHours
        EmpTotals["TotEmp"] = TotGrossPay
        EmpTotals["TotEmp"] = TotTax
        EmpTotals["TotEmp"] = TotNetPay
...
def PrintTotals(EmpTotals):    
    ...
    print(f'Total Hours Worked: {EmpTotals["TotEmp"]}')
    print(f'Total Gross Pay: {EmpTotals["TotEmp"]}')
    print(f'Total Income Tax:  {EmpTotals["TotEmp"]}')
    print(f'Total Net Pay: {EmpTotals["TotEmp"]}')
